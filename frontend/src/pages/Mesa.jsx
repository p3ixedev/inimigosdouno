...
const COR = {
  vermelho: { bg: 'bg-[oklch(0.63_0.24_27)]', glow: 'shadow-[0_0_30px_oklch(0.63_0.24_27/0.7)]', btn: 'bg-[oklch(0.63_0.24_27)] hover:bg-[oklch(0.68_0.24_27)]', hex: 'oklch(0.63 0.24 27)' },
  azul:     { bg: 'bg-[oklch(0.6_0.22_255)]',  glow: 'shadow-[0_0_30px_oklch(0.6_0.22_255/0.7)]',  btn: 'bg-[oklch(0.6_0.22_255)] hover:bg-[oklch(0.65_0.22_255)]',  hex: 'oklch(0.6 0.22 255)' },
  verde:    { bg: 'bg-[oklch(0.68_0.2_152)]',  glow: 'shadow-[0_0_30px_oklch(0.68_0.2_152/0.7)]',  btn: 'bg-[oklch(0.68_0.2_152)] hover:bg-[oklch(0.73_0.2_152)]',  hex: 'oklch(0.68 0.2 152)' },
  amarelo:  { bg: 'bg-[oklch(0.85_0.18_90)]',  glow: 'shadow-[0_0_30px_oklch(0.85_0.18_90/0.7)]',  btn: 'bg-[oklch(0.85_0.18_90)] hover:bg-[oklch(0.88_0.18_90)]',  hex: 'oklch(0.85 0.18 90)' },
};
...
function CartaMao({ carta, selecionada, onClick, disabled }) {
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`relative flex-shrink-0 rounded-xl select-none transition-shadow w-11 h-16 sm:w-14 sm:h-20 ${bgClass} ${selecionada ? 'ring-4 ring-white shadow-[0_0_25px_white/50]' : 'ring-1 ring-white/20'} ${disabled ? 'opacity-60 cursor-not-allowed' : 'cursor-pointer'}`}
      ...
      <div className="uno-bg min-h-screen flex items-center justify-center px-4">
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-xs text-zinc-500 mt-2">Manda esse codigo pros amigos!</p>
          </div>
  ...
  return (
    <div className="uno-bg relative min-h-screen flex flex-col overflow-hidden">
      <div
        ...
        style={{ background: corAtualObj ? `radial-gradient(ellipse at center, ${corAtualObj.hex}15 0%, transparent 70%)` : undefined }}
      />
      ...
      <div className="relative z-10 flex flex-col min-h-screen p-2 sm:p-3 gap-2">
          ...
          {estado.jogadores.filter((id) => id !== user.id).map((id) => {
            ...
            return (
              <motion.div
                ...
                className={`uno-card-surface rounded-2xl p-3 flex flex-col gap-2 transition-all ${ehVez ? 'ring-2 ring-[oklch(0.86_0.17_85)] shadow-[0_0_20px_oklch(0.86_0.17_85/0.3)]' : 'ring-1 ring-white/5'}`}
              >
                <div className="flex items-center gap-2">
                  {p && <UnoChip color={p.color} label={p.name[0]} sm />}
                  <div className="min-w-0 flex-1">
                    <p className="text-xs font-semibold truncate" translate="no">{p?.name}</p>
                    {ehVez && <p className="text-[10px] font-bold text-[oklch(0.86_0.17_85)] animate-pulse">vez dele</p>}
                  </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-3 py-2">
          {estado.corAtual && (
            <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full ${COR[estado.corAtual]?.bg || ''} shadow-lg`}>
          ...
          <div className="text-center">
            {ehMinhVez ? (
              <motion.p animate={{ opacity: [1, 0.5, 1] }} transition={{ repeat: Infinity, duration: 1.2 }} className="text-sm font-bold text-[oklch(0.86_0.17_85)]">
                Sua vez!
              </motion.p>
            ) : (
          ...
          {ehMinhVez && estado.fase === 'acaoZero' && (
            <motion.button initial={{ scale: 0 }} animate={{ scale: 1 }} onClick={() => setModal('acaoZero')} className="rounded-2xl bg-[oklch(0.85_0.18_90)] px-5 py-2.5 text-sm font-bold text-zinc-900 shadow-lg hover:opacity-90 transition">
